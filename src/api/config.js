...
// 실제 로그인은 아직 없지만 BE에 유저가 1~1,000,000번까지 전부 시딩돼 있어서(UserSeedRunner,
// Phase1 100만 유저 시딩 - 2026-08-24 원격 DB로 직접 확인함), 브라우저마다 이 범위 안에서 랜덤 ID를
// 하나 뽑아 localStorage에 고정해두면 사람마다 사실상 다른 계정처럼 동작한다.
